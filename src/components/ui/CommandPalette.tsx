...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const actions = [
    ...
    { id: 'cfo', label: 'CFO Intelligence Studio (DuPont ROE & Altman Z-Score)', category: 'Analitik & Intelligence', icon: Sparkles, shortcut: 'F8', run: () => onOpenCfo ? onOpenCfo() : onNavigate('analytics') },
    ...
    { id: 'forensic', label: 'Audit Forensik Buku Besar (SHA-256 Hash Chain)', category: 'Keamanan & Kepatuhan', icon: ShieldCheck, shortcut: 'F9', run: () => onOpenForensic && onOpenForensic() },
